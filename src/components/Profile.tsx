    ...
    <div className="container rounded bg-white mb-5">
        <div className="row">
          ...
          <div className="col-md-5 border-right">
            <div className="p-3 py-5">
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-12"><label className="labels">Address Line 1</label><input type="text" className="form-control" placeholder="enter address line 1" 
                style={{pointerEvents:'none'}}
                /></div>
                ...
                style={{pointerEvents:'none'}}
                 /></div>
                <div className="col-md-12"><label className="labels">Pincode</label><input type="text" className="form-control" placeholder="enter address line 2" 
                style={{pointerEvents:'none'}}
                /></div>
          ...
          <div className="col-md-4">
            <div className="p-3 py-5">
              <div className="d-flex justify-content-between align-items-center experience"><h4>Native Place adress</h4>
              <span className="border px-3 p-1 add-experience"
              onClick={editProfile}
              ><i className="fa fa-plus" />&nbsp;Edit</span></div><br />
              <div className="col-md-12"><label className="labels">Address Line 1</label><input type="text" className="form-control" placeholder="enter address line 1" style={{pointerEvents:'none'}} /></div>
              <div className="col-md-12"><label className="labels">Address Line 2</label><input type="text" className="form-control" placeholder="enter address line 2" style={{pointerEvents:'none'}} /></div>
              <div className="col-md-12"><label className="labels">Pincode</label><input type="number" className="form-control" placeholder="enter pincode" style={{pointerEvents:'none'}} /></div>
              <div className="col-md-12 py-4"><label className="labels">Adhar Card</label>
              <div className='col-md-12'>
              <img style={{height:'300px'}}src={"http://localhost:5000/"+userdata.image} />
              </div>
              </div>
